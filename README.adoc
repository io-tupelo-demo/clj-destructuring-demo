...
= Clojure Destructing Demo

Live examples (via unit tests) of Clojure destructuring techniques, including map destructuring,
sequence destructuring, and function argument destructuring.
